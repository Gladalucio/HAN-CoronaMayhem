...
CoronaMayhem is a platformer based on Mario Mayhem and built using the HAN University Of Applied Sciences' own [game engine (OOPG)](https://github.com/HANICA/oopg), which uses [Processing](https://processing.org/) under the hood.
A demo game called Waterworld was made using this engine which is also [available on Github]((https://github.com/HANICA/waterworld)). 

CoronaMayhem was made for a project for school. If you want, you can run this for yourself, but it's very important you don't use any JDK version higher than 1.8 (Java version 14.0), otherwise the engine won't work. 

---
---
---
# Original Waterworld README (in Dutch): 
